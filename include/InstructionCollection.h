...
const InstructionCollection MATH_INTRINSIC = {"llvm.fmuladd", "llvm.canonicalize", "llvm.smul.fix.sat", "llvm.umul.fix", "llvm.smul.fix", "llvm.sqrt",
    "llvm.powi", "llvm.sin", "llvm.cos", "llvm.pow", "llvm.exp", "llvm.exp2", "llvm.log", "llvm.log10", "llvm.log2", "llvm.fma", "llvm.fabs", "llvm.minnum",
    "llvm.maxnum", "llvm.minimum", "llvm.maximum", "llvm.copysign", "llvm.floor", "llvm.ceil", "llvm.trunc", "llvm.rint", "llvm.nearbyint", "llvm.round",
    "llvm.lround", "llvm.llround", "llvm.lrint", "llvm.llrint"};
const InstructionCollection GENERAL_INTRINSIC = {"llvm.assume", "llvm.lifetime.start", "llvm.lifetime.end", "llvm.experimental.noalias.scope.decl" }; // others should be added
