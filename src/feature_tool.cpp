...
cl::opt<FeatureSetOptions> FSet("fset", cl::desc("Specify the feature set:"), cl::values(clEnumVal(fan19, "Default feature set for GPU used in [Fan et al. ICPP 19]"), clEnumVal(grewe13, "Feature set used in pGrewe et al. 13]"), clEnumVal(full, "Feature set mapping all LLVM IR opcode (very large, hard to cover)")));
